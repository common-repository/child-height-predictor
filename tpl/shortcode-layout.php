...
<div class="childheight_shortcode">
    <?php $options = get_option('childheight_plugin');?>
    <h3 class="childheight-title">
	<?php _e('Child height Calculator', 'childheight_plugin'); ?>
    </h3>
...
<?php if($options['allowlink1'] == 'yes'){?>
    ...
    <div class="childheight-shortcode_result" id="childheight-<?php echo $postTitle; ?>result">
